...
router.get("/add", authMiddleware.isAuthenticated, recipeController.showAddform);
router.post("/add", authMiddleware.isAuthenticated, recipeController.createRecipes);

//Update this one has param so we put param placeholder
router.get("/edit/:id", authMiddleware.isAuthenticated, recipeController.showEditForm);

router.post("/edit/:id", authMiddleware.isAuthenticated, recipeController.updateRecipes);
//delete, since eveyrhting is happpening in the recipe file
//no need to get anything for this part
router.post("/delete/:id", authMiddleware.isAuthenticated, recipeController.deleteRecipes);
